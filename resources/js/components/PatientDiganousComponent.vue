                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <button class="btn btn-outline-primary"> <a class="profile" :href="'/DoctorDetails/' + doctor.id">
                                            Profile </a> </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row my-3">
                            <div class="col-xl-6 col-sm-6 my-3" v-for="dig in diagnosis" :key="dig.id">
                                <a :href="'/ShowDiganous/' + dig.id" style="color: #000">
                                    <div class="card">
...
export default {
    ...
    methods: {
        ...
        getPatient() {
            axios.get('http://localhost:8000/api/patients/get-user-by-user/' + this.user_id)
                .then((response) => {
