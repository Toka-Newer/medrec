                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row my-3">
                            <div class="col-xl-6 col-sm-6 my-3" v-for="dig in diagnosis" :key="dig.id">
                                <a :href="'/EditDiganous/' + dig.id" style="color: #000">
                                    <div class="card">
                    ...
                    <div class="col-md-4">
                        <div class="row my-3">
                            ...
                            <div class="col-md-12 my-3" v-for="Surgery in surgeries" :key="Surgery.id">
                                <a :href="'/EditReport/' + Surgery.id" style="color: #000">
                                    <div class="card">
                                        <div class="card-body hvr-shadow">
                                            <div class="card-title">
                                                <i class="fa fa-star pr-2"
                                            ...
                                            <div>
                                                <div class="hvr-shadow text-center fl d-flex flex-column align-items-center text-center border"
                                                    style="padding: 5%; border-radius: 7%;">
                                                    <p>Date</p> <span> {{ moment(Surgery.created_at).format("DD-MM-YYYY") }}
                                                    </span>
                                                </div>
                                                <div class="fl d-flex flex-column align-items-center text-center"
                                                    style="padding: 8%;">
        ...
        getPatient() {
            ...
            axios.get('http://localhost:8000/api/patients/get-user/' + this.patient_id)
                .then((response) => {
                    ...
                    for(var i = 0; i< this.patient.diagnosis.length; i++){
                        if(this.patient.diagnosis[i].doctor_id == this.doctor.id){
                            this.diagnosis.push(this.patient.diagnosis[i])
                        }
                    }
                    for(var i = 0; i< this.patient.surgeries.length; i++){
                        if(this.patient.surgeries[i].doctor_id == this.doctor.id){
                            this.surgeries.push(this.patient.surgeries[i])
                        }
                    }
                })
        },
