            ...
            <div class="container">
                <div class="signup-content row">
                    <div id="registration" class="signup-form col-md-6">
                        <h2 class="form-title" style="margin-bottom: 4%;">{{ __('Sign up') }}</h2>
                        ...
                        <form method="POST" class="register-form" id="register-form" action="{{ url('/register')}}">
                            @CSRF
                            <div id="app" class="form-group mb-3">
                            ...
                            <div class="form-group mb-3 row mx-1">
                                <div class="custom-control custom-radio col-xs-6">
                                    <label style="float: left;" class="custom-control-label" for="customRadio1">Male</label>
                                    <input style="width:85%" type="radio" id="customRadio1" value="male" name="gender" class="custom-control-input">
                                </div>
                                <div class="custom-control custom-radio col-xs-6">
                                    <label style="float: left;" class="custom-control-label" for="customRadio2">Female</label>
                                    <input style="width:80%" type="radio" id="customRadio2" value="female" name="gender" class="custom-control-input">
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <i class="fa fa-lock"></i>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <label class="mb-4">Choose sign up As:</label>
                    ...
                    <div class="signup-image col-md-6">
                        ...
                        <a href="{{ route('login') }}" class="signup-image-link text-center my-3">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
